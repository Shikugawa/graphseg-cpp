...
private:
  ...
  /// </summary>
  bool IsMergable(const std::vector<Vertex> &sg1, const std::vector<Vertex> &sg2)
  {
  ...
  std::vector<Vertex> GetMergedSegment(const std::vector<Vertex> &first_itr, const std::vector<Vertex> second_itr)
  {
...
private:
  double SegmentRelatedness(const Embedding<VectorDim, LangType> &embedding, const std::vector<Vertex> &seg1, const std::vector<Vertex> &seg2)
  {
    double rel = 1.0;
  ...
  void ConstructMergedSegment()
  {
    ...
    // std::vector<bool> segment_memo(segments.size(), false);
    ...
    for (size_t i = 0; i < segments.size() - 1; ++i)
    {
      ...
      {
        std::vector<Vertex> merged_segment = GetMergedSegment(current_segment, adjacent_segment);
        MarkForward(i);
